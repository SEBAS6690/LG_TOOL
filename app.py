...
# ==========================================
    ...
    if st.button("📊 Abrir Dashboard e Historial Interactivo", key="btn_historial_principal"):
    ...
    if st.session_state.ver_historial:
        ...
        try:
            ...
            if total_f > 0:
                ...
                rechaz_f = len(df_interactivo[df_interactivo[col_estado].astype(str).str.upper() == "RECHAZADO"])
